...
\begin{acronym}[SSCS]
    ...
    \acro{resnet101}[ResNet-101]{101 layer residual network}
...
This research develops lightweight DL models
...
we evaluate five image segmentation models 
(i.e., U-Net, U-Net++, FPN, LinkNet and MA-Net)
and three pruning algorithms
(i.e., linear, AGP and movement pruning) on two metal corrosion
...
IoU reduction on the SSCS dataset and less than
$5\%$ IoU reduction on the NEA dataset.}

\keyword{metal corrosion, computer vision, image segmentation, deep learning, pruning} 
...
\begin{figure}[!ht]
    \centering
      ...
      \begin{subfigure}[t]{.29\textwidth} 
        ...
        \caption{U-Net, \ac{mp}, and $\zeta_f=0.5$ for the \ac{nea} dataset}
...
\begin{figure}[!ht]
    ...
    %   \hfill
      \begin{subfigure}[t]{.4\textwidth}
        ...
        \caption{Label mask generated by LinkNet}
...
\begin{figure}[!ht]
  ...
  %   \hfill
    \begin{subfigure}[t]{.4\textwidth}
      ...
      \label{fig:results:pruning:visualization:ccsc-linknet}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[t]{.29\textwidth} 
      \centering
      \includegraphics[width=.95\linewidth]{figures/pruning-results/linknet_CCSC_agp/0/mask_0.2.jpg}
      \caption{\ac{agp}, $\zeta_f=0.2$}
      \label{fig:results:pruning:visualization:ccsc-linknet-agp-0.2}
    \end{subfigure} 
    \begin{subfigure}[t]{.29\textwidth} 
      \centering
      \includegraphics[width=.95\linewidth]{figures/pruning-results/linknet_CCSC_agp/0/mask_0.5.jpg}
      \caption{\ac{agp}, $\zeta_f=0.5$}
      \label{fig:results:pruning:visualization:ccsc-linknet-agp-0.5}
    \end{subfigure}
    \begin{subfigure}[t]{.29\textwidth} 
      \centering
      \includegraphics[width=.95\linewidth]{figures/pruning-results/linknet_CCSC_agp/0/mask_0.9.jpg}
      \caption{\ac{agp}, $\zeta_f=0.9$}
      \label{fig:results:pruning:visualization:ccsc-linknet-agp-0.9}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[t]{.29\textwidth} 
      \centering
      \includegraphics[width=.95\linewidth]{figures/pruning-results/linknet_CCSC_linear/0/mask_0.2.jpg}
      \caption{\ac{lp}, $\zeta_f=0.2$}
    ...
    \begin{subfigure}[t]{.29\textwidth} 
      ...
      \caption{\ac{lp}, $\zeta_f=0.9$}
      \label{fig:results:pruning:visualization:ccsc-linknet-lp-0.9}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[t]{.29\textwidth} 
      \centering
      \includegraphics[width=.95\linewidth]{figures/pruning-results/linknet_CCSC_movement/0/mask_0.2.jpg}
      \caption{\ac{mp}, $\zeta_f=0.2$}
      \label{fig:results:pruning:visualization:ccsc-linknet-mp-0.2}
    \end{subfigure}
    \begin{subfigure}[t]{.29\textwidth} 
      \centering
      \includegraphics[width=.95\linewidth]{figures/pruning-results/linknet_CCSC_movement/0/mask_0.5.jpg}
      \caption{\ac{mp}, $\zeta_f=0.5$}
